  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      $('#btnConfirmarBorrado').click(function() {
        window.location = '/codigo-base/php/facturas/borrarfactura.php?codigofactura=' + codigofactura;
      });

      $('.botonimprimir').click(function() {
        window.open('/codigo-base/php/facturas/facturapdf.php?' + '&codigofactura=' + $(this).get(0).dataset.codigo, '_blank');
      });
